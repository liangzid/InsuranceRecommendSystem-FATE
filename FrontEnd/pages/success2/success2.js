...
Page({
    ...
    data: {
        // 背景图列表
        imgArray: ["../../images/new1.png", "../../images/pignan.png", "../../images/changan.png", "../../images/renbao.png", "../../images/new2.png", "../../images/new3.png", "../../images/new4.png"],
        // 文字列表，和前面的图位置对应
